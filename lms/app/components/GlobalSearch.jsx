  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      <div className="relative">
        ...
        <input
          type="text"
          className="w-full bg-[#16192b] border border-[#1e233d] text-sm text-white placeholder-zinc-500 rounded-full pl-9 pr-10 py-1.5 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors"
        ...
        {isSearching && (
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
            <svg className="animate-spin w-4 h-4 text-cyan-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
