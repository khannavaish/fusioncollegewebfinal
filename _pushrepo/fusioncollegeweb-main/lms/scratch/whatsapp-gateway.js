...
app.listen(PORT, () => {
    console.log(`🚀 Free WhatsApp API Gateway running on http://localhost:${PORT}`);
    console.log(`👉 Send POST requests to http://localhost:${PORT}/send with JSON: { "to": "923001234567", "message": "Hello" }`);
});
